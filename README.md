...
At the very beginning, we create a .py file in the directory from and import iden_isharp
...
Our first application is almost ready, it remains to write a command for the build!
